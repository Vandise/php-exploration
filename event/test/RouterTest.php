...
class RouterTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->factory = new \Amber\Event\Factory\RouterFactory;
    ...
    {
        $this->assertInstanceOf('\Amber\Event\Dispatch\Route', $actual);
    }
    ...
    /**
     * @expectedException \Amber\Event\Exception\RouteNotFound
     */
    public function testAddAndGenerate()
    {
        ...
        // fail to match
        //$this->setExpectedException('\Amber\Event\Exception\RouteNotFound');
    ...
    public function testGetAndSetRoutes()
    {
        ...
        $this->assertInstanceOf('\Amber\Event\Dispatch\RouteCollection', $actual);
        $this->assertTrue(count($actual) == 2);
        $this->assertInstanceOf('\Amber\Event\Dispatch\Route', $actual['page.browse']);
        $this->assertEquals('/page/', $actual['page.browse']->path);
        $this->assertInstanceOf('\Amber\Event\Dispatch\Route', $actual['page.read']);
    ...
    /**
     * @expectedException     \Amber\Event\Exception\UnexpectedValue
     */
    public function testArrayAccess()
    {
        ...
        //$this->setExpectedException('\Amber\Event\Exception\UnexpectedValue');
