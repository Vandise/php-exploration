...
class GeneratorTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->generator = new \Amber\Event\Dispatch\RouteGenerator;
        $this->factory = new \Amber\Event\Factory\RouteFactory;
        $this->server = $_SERVER;
    }
     ...
     */
    public function testGenerateControllerAsClosure()
    {
