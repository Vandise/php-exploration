 ...
 * @version v0.1.0
 */
class RouteCollection extends \Amber\Event\Parse\AbstractSpec implements ArrayAccess,Countable,IteratorAggregate
{
  ...
  public function __construct( \Amber\Event\Factory\RouteFactory $route_factory, array $routes = array() ) 
  {
  ...
  public function offsetSet( $name, $route )
  {
    ...
    {
      throw new \Amber\Event\Exception\UnexpectedValue;
    }
  ...
  protected function resourceCallable( \Amber\Event\Dispatch\RouteCollection $router )
  {
